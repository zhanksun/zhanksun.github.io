...
8. Wang, Z., Liu, R., Sun, Z., 2022. [Physician Scheduling for Emergency Departments Under Time-Varying Demand and Patient Return](https://doi.org/10.1109/TASE.2022.3163259). _IEEE Transactions on Automation Science and Engineering_, 20(1), 553-570. [\[pdf\]](/files/Physician_Scheduling_with_Patient_Return.pdf)
...
11. Hao, S., Sun, Z., Xu, Y., 2024. Emergency Care Efficiency vs. Quality: Uncovering Hidden Consequences of Fast-Track Routing Decisions. _Manufacturing & Service Operations Management, accepted_. [\[pdf\]](/files/FT_routing_final.pdf)
